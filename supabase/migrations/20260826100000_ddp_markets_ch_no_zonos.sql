-- =============================================================================
-- Switzerland ships without "Sender pays with Zonos" (Mario, 26-Aug-2026): a
-- CH order will NEVER have a ZONOS record, and that is correct — so a CH row
-- counts as matched with a freight cost alone, and never appears in the
-- "awaiting ZONOS" exception list. DE and DK still require both legs.
-- =============================================================================
